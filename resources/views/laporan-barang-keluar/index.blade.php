                        ...
                        $.each(response, function(index, item) {
                            getCustomerName(item.customer_id, function(customer){
                                ...
                                var rowNode = table.row.add([
                                    ...
                                    `<span class="badge px-3 py-2" style="border-radius: 8px; font-weight: 700; background-color: rgba(220, 53, 69, 0.1); color: #dc3545;">${item.jumlah_keluar}</span>`,
                                    `<span style="font-size: 13px; color: #064E3B; font-weight: 500;">${customer}</span>`
                                ]).draw(false).node();
