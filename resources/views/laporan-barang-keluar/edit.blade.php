...
<div class="row">
    <div class="col-lg-8 offset-lg-2">
        ...
        <div class="card card-premium p-4">
            <div class="card-body">
                <form action="/laporan-barang-keluar/{{ $transaksi->id }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group mb-3">
                        <label for="jumlah_keluar" class="font-weight-bold" style="color: var(--corp-dark);">Jumlah Keluar Baru</label>
                        <input type="number" name="jumlah_keluar" id="jumlah_keluar" class="form-control form-control-premium" value="{{ $transaksi->jumlah_keluar }}" required min="1">
                    </div>

                    <div class="form-group mb-4">
                        <label for="tanggal_keluar" class="font-weight-bold" style="color: var(--corp-dark);">Tanggal Transaksi</label>
                        <input type="date" name="tanggal_keluar" id="tanggal_keluar" class="form-control form-control-premium" value="{{ $transaksi->tanggal_keluar }}" required>
                    </div>

                    <div class="d-flex justify-content-end">
                        <a href="/laporan-barang-keluar" class="btn btn-secondary mr-2 font-weight-bold px-4" style="border-radius: 12px;">Batal</a>
