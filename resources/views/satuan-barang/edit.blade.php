        ...
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data">
                <div class="modal-body">
                    <!-- Menyimpan ID Satuan yang disembunyikan -->
                ...
                <div class="modal-footer bg-whitesmoke br">
                    ...
                    <!-- PERBAIKAN: Mengubah id="update" menjadi id="update_satuan" agar sinkron dengan jQuery -->
                    <button type="button" class="btn btn-primary" id="update_satuan">Edit</button>
                </div>
            </form>
        </div>
    </div>
