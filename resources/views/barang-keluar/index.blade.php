...
<style>
    ...
    /* Badge khusus kuantitas keluar */
    .badge-out-premium {
        background-color: #FEF3C7 !important; /* Amber/Orange soft */
...
<div class="section-header mb-4">
    <h1>Barang Keluar</h1>
    <div class="ml-auto">
        <a href="javascript:void(0)" class="btn btn-premium-corp d-flex align-items-center" id="button_tambah_barangKeluar">
    ...
    function generateRowHtml(counter, value, customerName) {
        return `
            <tr class="barang-row" id="index_${value.id}">
                ...
                <td style="font-size: 13px; color: #6b7280;">${value.tanggal_keluar}</td>
                <td style="font-size: 14px; font-weight: 600; color: var(--corp-dark);">${value.nama_barang}</td>
                <td><span class="badge badge-out-premium px-3 py-2">${value.jumlah_keluar}</span></td>
                <td style="font-size: 13px; color: #047857; font-weight: 500;">${customerName}</td>
