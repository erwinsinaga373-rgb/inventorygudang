...
<div class="section-header mb-4">
    <h1>Data Customer</h1>
    <div class="ml-auto">
        <a href="javascript:void(0)" class="btn btn-premium-corp d-flex align-items-center" id="button_tambah_customer">
        ...
        function generateRowHtml(counter, value) {
            return `
                <tr class="barang-row" id="index_${value.id}">
                    ...
                    <td style="font-size: 14px; font-weight: 600; color: var(--corp-dark);">${value.customer}</td>
